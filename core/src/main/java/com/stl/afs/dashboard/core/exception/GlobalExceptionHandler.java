 ...
 */
package com.stl.afs.dashboard.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleBadRequestException(HttpServletRequest req, Exception e) {
        ...
        log.error("Error URL: " + req.getRequestURL().toString() + " Error Class: " + e.getClass().getName() + "...Message: " + e.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleBrokenPipeException(HttpServletRequest request, IOException e) {
        ...
        log.error("Error URL: " + request.getRequestURL().toString() + " Error Class: " + e.getClass().getName() + "...Message: " + e.getMessage());
